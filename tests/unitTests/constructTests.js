define([
    ...
    test('Construct passes arguments to extend', function() {
        var Derived = Construct('test', {foo:1}, {bar:2});

        strictEqual(Derived.fullName, 'test', 'fullName passed');
        strictEqual(Derived.foo, 1, 'static props passed');
        strictEqual(Derived.prototype.bar, 2, 'instance props passed');
    });
    ...
    test('Construct defaults extend constructor', function() {
        var Derived = Construct.extend({
            defaults: {
                foo: 1
            }
        ...
        strictEqual(Derived.foo, 1, 'Constructor has a foo property');
    });
